...
/**
 * 用多线程多任务的方式处理，大部分代码和单线程类似，只是需要将任务放到线程池中处理并处理好数据安全问题。
 * 关键字：多线程，多任务，线程池，共享资源的问题，数据安全
 */
...
//        executorService = Executors.newCachedThreadPool();
        executorService = Executors.newFixedThreadPool(10); //建立一个容量为10的固定尺寸的线程池
        Intent intent = new Intent(Constanse.ACTION_COMPRESS_BROADCAST);
        intent.putExtra(Constanse.KEY_COMPRESS_FLAG,Constanse.FLAG_BEGAIIN);//flag_begaiin
